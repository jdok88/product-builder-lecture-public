...
const dinnerMenus = [
    ...
    { name: "떡볶이", apiEndpoint: "https://foodish-api.com/api/images/tteokbokki", recipe: "1. 떡을 물에 불립니다. 2. 냄비에 물, 고추장, 설탕, 간장을 넣고 끓입니다. 3. 떡과 어묵을 넣고 끓여줍니다." },
    ...
    { name: "김치찌개", apiEndpoint: "https://foodish-api.com/api/images/kimchi", recipe: "1. 냄비에 김치와 돼지고기를 넣고 볶습니다. 2. 물을 붓고 끓입니다. 3. 두부, 파 등을 넣고 한소끔 더 끓입니다." },
    { name: "된장찌개", apiEndpoint: "https://foodish-api.com/api/images/jjigae", recipe: "1. 냄비에 멸치 육수를 냅니다. 2. 된장을 풀고 애호박, 두부, 버섯 등을 넣고 끓입니다. 3. 마지막에 파와 고추를 넣습니다." },
    ...
    { name: "초밥", apiEndpoint: "https://foodish-api.com/api/images/sushi", recipe: "1. 밥에 식초, 설탕, 소금을 섞어 초밥용 밥을 만듭니다. 2. 신선한 회를 준비합니다. 3. 밥 위에 회를 얹어 만듭니다." },
